    ...
    **kwargs: Any,
    ...
    try:
        ...
        # Don't use async with context manager, use client directly
            ...
            # chat.completions.parse() provides structured output and is
            # inherently non-streaming; passing stream=True raises a TypeError
            # for OpenAI-compatible providers that set stream in kwargs.
